 ...
 * {@code streamGenericParseIDOrReply}（:1173）与 {@code string2ull}（:1147）。
 *
...
public final class StreamIdFormat {
    ...
    /** 上游 :1174-1175 的 {@code char buf[128]}：超过 127 字节直接判非法。 */
     ...
     *                   单独的 {@code -} 与 {@code +} 在这些位置是非法 ID（上游 :1180-1181）
